...
5.经过n个账号测试，暂未发现封号风险，如果每天一直使用，不保证不会封号。
...
1.手机系统：仅支持安卓系统，最好是安卓7.0以上。本人的手机安卓版本：10

2.手机型号：目前经过测试能完美运行的：红米K20 Pro，华为nova5pro，其他机型未知。
...
附：如果不小心中途操作手机导致脚本执行失败，重启脚本软件再执行即可。
